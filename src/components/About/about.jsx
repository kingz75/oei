...
export default function AboutUs() {
  return (
    <section className="bg-[url('/src/assets/back/aboutbg.png')] bg-no-repeat bg-center bg-cover lg:px-[120px]  lg:pt-[170px] pt-[90px] font-dmSans">
      <div className="px-[16px] lg:px-0">
        {/* Mobile Heading */}
        <div className="lg:hidden">
          <div>
            <h2 className="text-[24px] font-medium text-[#182948] font-playfair">
              About Us
            </h2>
        ...
        <div className="flex flex-col lg:flex-row justify-between lg:gap-[40px] mb-[70px]">
          ...
          <div className="bg-[url('/src/assets/back/abbg1.png')] rounded-xl bg-no-repeat bg-cover bg-center flex flex-col justify-between h-[90vh] lg:h-auto">
            ...
            <div className="lg:mt-[40px] lg:px-8 mt-[30px] px-4">
              <span className="bg-[#ABC452] text-[#ffffff] text-[16px] font-bold px-6 py-3 rounded-md font-playfair">
                ABOUT US
              </span>
            </div>
            {/* Bottom Write-up */}
