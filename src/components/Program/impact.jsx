...
const ImpactReport = () => {
  return (
    <div>
      <div className="  grid grid-cols-1 lg:grid-cols-2   gap-[40px]  lg:my-[50px] my-[24px] lg:px-[120px] px-[16px] ">
        {/* Left Section - Impact  */}
        <div className="flex flex-col justify-between h-full  ">
          {/* Header */}
          <div className="mb-[10px]">
            <h1 className="mb-2 text-[32px] text-[#182948] font-medium">
              Impact so far
            </h1>
          ...
          <div className="grid grid-cols-2  gap-8 mb-12">
            <div className="group">
              ...
              <div className="lg:text-[32px] text-[24px] font-medium text-[#182948] mb-2 group-hover:scale-110 transition-transform duration-300">
                20,000
              </div>
        ...
        <div className="bg-[url('/src/assets/back/impactbg.png')] bg-no-repeat bg-cover lg:px-[32px] px-2 lg:py-10 py-8  text-[#ffffff] flex flex-col justify-between lg:rounded-none rounded-md">
          {/* Header */}
          <div>
            <h2 className="mb-4 text-[32px] leading-[32px] font-medium text-[#ffffff]">
