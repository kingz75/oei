    ...
    <section className="bg-[url('/src/assets/back/aboutbg.png')] bg-no-repeat">
      <div className="lg:pt-[120px] pt-[90px] lg:px-[120px] px-[16px] lg:mb-[75p] mb-[32px] ">
        ...
        <div className="text-center lg:mb-[60px] mb-[32px]">
          <h1 className="lg:text-[32px] text-[24px] font-bold text-[#182948] lg:mb-[20px] mb-[10px]">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-x-[16px] lg:gap-y-[60px] flex-wrap">
          {allPrograms.map((program) => (
            <Link
              ...
              style={{ backgroundImage: `url(${getBackgroundImage(program)})` }}
            >
              <div className="lg:mt-[40px] md:mt-8 mt-6 lg:px-8 md:px-6 px-4">
                <span className="bg-[#ABC452] text-[#ffffff] lg:text-[16px] md:text-sm text-xs font-bold lg:px-6 md:px-5 px-4 lg:py-3 md:py-2 py-2 rounded-md inline-block">
                  {program.label}
                </span>
              </div>
              <div className="lg:pb-[20px] md:pb-4 pb-3 lg:px-8 md:px-6 px-4">
                <h2 className="text-[#ffffff] lg:text-[32px] text-[24px] font-medium mb-2 ">
                  {program.title}
                </h2>
